The following files were generated for 'microblaze_mcs_v1_3' in directory
J:\Documents\Projects\Pipistrello_v2.0\opl3_player\ise\ipcore_dir\

Generate XCO file:
   CORE Generator input file containing the parameters used to generate a core.

   * microblaze_mcs_v1_3.xco

Generate Implementation Netlist:
   Binary Xilinx implementation netlist files containing the information
   required to implement the module in a Xilinx (R) FPGA.

   * microblaze_mcs_v1_3.ngc

Misc Files Generator:
   Please see the core data sheet.

   * microblaze_mcs_v1_3/mb_bootloop_le.elf
   * microblaze_mcs_v1_3/microblaze_mcs_setup.tcl
   * microblaze_mcs_v1_3/system_template.tcl
...
Generate Script:
   ...
   * microblaze_mcs_v1_3.bmm
   * microblaze_mcs_v1_3_sdk.xml
...
Generate Instantiation Templates:
   ...
   * microblaze_mcs_v1_3.veo

RTL Simulation Model Generator:
   Please see the core data sheet.

   * microblaze_mcs_v1_3.v
...
Deliver IP Symbol:
   ...
   * microblaze_mcs_v1_3.asy

Synthesis ISE Generator:
   Please see the core data sheet.

   * microblaze_mcs_v1_3.gise
   * microblaze_mcs_v1_3.xise

Deliver Readme:
   Readme file for the IP.

   * microblaze_mcs_v1_3_readme.txt

Generate FLIST file:
   Text file listing all of the output files produced when a customized core was
   generated in the CORE Generator.

   * microblaze_mcs_v1_3_flist.txt
