...
void S_Start(void)
{
  ...
  fprintf(stdout, "S_Start: gameepisode = %d, gamemap = %d\n", gameepisode, gamemap);
  ...
  int		volume )
{
  ...
  {
    rc = 
      S_AdjustSoundParams(players[consoleplayer].mo, 
                          origin, 
                          &volume, 
                          &sep, 
                          &pitch);
  ...
  int			looping )
{
  ...
  // play it
  fprintf(stdout, "S_ChangeMusic: Playing song %s\n", music->name);
